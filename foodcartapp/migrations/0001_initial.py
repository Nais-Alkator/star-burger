    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PR', 'Processed'), ('UNPR', 'Unprocessed')], db_index=True, default='UNPR', max_length=4, verbose_name='Статус заказа')),
                ('comment', models.TextField(blank=True, verbose_name='Комментарий к заказу')),
                ('registrated_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now, verbose_name='Зарегистрирован в')),
                ...
                ('payment_method', models.CharField(choices=[('cash', 'Cash'), ('card', 'Card'), ('ns', 'not specified')], db_index=True, default='ns', max_length=15, verbose_name='Способ оплаты')),
            ],
            options={
                'verbose_name': 'Заказ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_price', models.DecimalField(decimal_places=2, max_digits=7, validators=[django.core.validators.MinValueValidator(0.0)], verbose_name='Цена одного товара')),
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders_with_product', to='foodcartapp.product', verbose_name='Категория товара')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='order',
            name='restaurant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order', to='foodcartapp.restaurant', verbose_name='Обслуживающий ресторан'),
        ),
        migrations.CreateModel(
