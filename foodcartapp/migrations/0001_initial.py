    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_of_order', models.CharField(choices=[('PR', 'Processed'), ('UNPR', 'Unprocessed')], db_index=True, default='UNPR', max_length=4, verbose_name='Статус заказа')),
                ...
                ('called_at', models.DateTimeField(db_index=True, null=True, verbose_name='Позвонили в')),
                ('delivered_at', models.DateTimeField(db_index=True, null=True, verbose_name='Доставлен в')),
                ('payment_method', models.CharField(choices=[('cash', 'Cash'), ('card', 'Card')], db_index=True, default='cash', max_length=15, verbose_name='Способ оплаты')),
            ],
            options={
                'verbose_name': 'Заказ',
        ...
        migrations.AddField(
            model_name='order',
            name='restaurant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_restaurant', to='foodcartapp.restaurant', verbose_name='Обслуживающий ресторан'),
        ),
        migrations.CreateModel(
